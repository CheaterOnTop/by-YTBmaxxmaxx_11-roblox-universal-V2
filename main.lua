    ...
    function XyloKitUIWindow:CreateTab(name)
        ...
        function tab:CreateSection(name)
            ...
            function section:CreateSlider(name, description, min, max, default, callback)
                ...
                sliderBar.Position = UDim2.new(0, 5, 0, 45)
        ...
        playerInfoFrame.Size = UDim2.new(0, 250, 0, 60)
        playerInfoFrame.Position = UDim2.new(0, 5, 1, -5)
        ...
        playerProfileImage.Size = UDim2.new(0, 40, 0, 40)
        playerProfileImage.Position = UDim2.new(1, -50, 0.5, -20)
        playerProfileImage.BackgroundTransparency = 1
        playerProfileImage.Image = player and "rbxthumb://id=" .. player.UserId .. "?width=420&height=420" or "rbxassetid://0"
        playerProfileImage.Parent = playerInfoFrame

        playerProfileImage.ImageRectSize = Vector2.new(40, 40)
        playerProfileImage.ImageRectOffset = Vector2.new(0, 0)
        playerProfileImage.ScaleType = Enum.ScaleType.Fit
        local circleMask = Instance.new("ImageLabel")
        circleMask.Size = UDim2.new(1, 0, 1, 0)
        circleMask.BackgroundTransparency = 1
        circleMask.Image = "rbxassetid://266543268"
